...
export const HeaderActions = () => {
  ...
  return (
    ...
    <button onClick={() => setOpen(true)} className={styles.btn_user}><FontAwesomeIcon className={styles.icon_user} icon={faUser} /></button>
    </div>

    <div className={styles.component_cart}>
    <Link href='/shopCart/ShopCart'><button className={styles.btn_cart}><FontAwesomeIcon className={styles.icon_cart} icon={faCartShopping} /></button></Link>
    </div>
    </div>
    </div>
